...
(function() {
    ...
    if (n = "https://js.stripe.com", g = "https://js.stripe.com", h = !! /stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0), f = "console" in window && "warn" in window.console, e = function() {
        var a;
        return (null != (a = window.performance) && "function" == typeof a.now ? a.now() : void 0) || ("function" == typeof Date.now ? Date.now() : void 0) || +new Date
    }, m = e(), k = {}, !h && "querySelectorAll" in document && f && (l = document.querySelectorAll('script[src^="' + n + '"]'), l.length || console.warn("It looks like Stripe.js is not being loaded from https://js.stripe.com. Stripe does not support serving Stripe.js from your own domain.")), a = function() {
        function a() {
        ...
        return a.version = 2, a.endpoint = "https://api.stripe.com/v1", a.StripeV3 = null, a.setPublishableKey = function(b) {
            ...
            return d
        }, a.trackPerf = !1, a._isChannel = "#__stripe_transport__" === ("undefined" != typeof window && null !== window ? window.location.hash : void 0), a._isSafeStripeDomain = h, a._iframeOnAmount = 1, a._isSafeDomain = function() {
        ...
        }, a._iframeBaseUrl = g, a._stripejsBaseUrl = n, a._relayResponse = function(b, c, d) {
    ...
    for (this.Stripe = a, this.Stripe.token = function() {
        ...
        return r(c, b), c.tokenName = "card", c.whitelistedAttrs = ["number", "cvc", "exp", "exp_month", "exp_year", "name", "address_line1", "address_line2", "address_city", "address_state", "address_zip", "address_country", "currency"], c.createToken = function(b, d, f) {
            var g, h, i;
        ...
        return r(c, b), c.tokenName = "bank_account", c.whitelistedAttrs = ["country", "currency", "routing_number", "account_number", "name", "account_holder_type", "account_holder_name"], c.createToken = function(b, d, e) {
        ...
        return r(c, b), c.tokenName = "pii", c.whitelistedAttrs = ["personal_id_number"], c.createToken = function(b, d, e) {
        ...
        return r(c, b), c._whitelistedAttrs = ["amount", "currency", "email", "description"], c.createReceiver = function(b, c) {
            var d;
        ...
        return r(c, b), c.stripeAccount = null, c.create = function(b, c) {
            var d, e;
    ...
    }(), d = ["createToken", "getToken", "cardType", "validateExpiry", "validateCVC", "validateCardNumber"], o = 0, p = d.length; o < p; o++) i = d[o], this.Stripe[i] = this.Stripe.card[i];
    if (this.Stripe.stripejs_ua = "stripe.js/f95d044", !this.Stripe._isChannel && true) try {
        "function" == typeof window.addEventListener && window.addEventListener("message", function(b) {
            ...
            try {
                ...
                try {
                    if (k = document.querySelector("meta[name=referrer]"), null != k) switch (l = null != (s = k.content) ? s.toLowerCase() : void 0) {
                        case "origin":
                        case "strict-origin":
                ...
                i = document.createElement("iframe"), i.src = "https://js.stripe.com/v2/m/outer.html" + e, i.style.cssText = "width: 1px !important; height: 1px !important;\nposition: fixed !important; visibility: hidden !important;\npointer-events: none !important", i.setAttribute("frameborder", "0"), i.setAttribute("allowTransparency", "true"), i.setAttribute("scrolling", "no"), i.setAttribute("tabIndex", "-1"), i.setAttribute("aria-hidden", "true"), document.body.appendChild(i), n = window.location.href, setInterval(function() {
                    var c, d;
        ...
        "function" == typeof document.addEventListener && document.addEventListener("paste", function(b) {
            ...
            try {
                if (c = {
                    ...
                    "postal-code": "zip",
                    zip: "zip"
                }, d = c[b.target.autocomplete] || a.utils.typeOfString(b.clipboardData.getData("text/plain"))) return k[d] = !0
            } catch (e) {
                b = e
            }
        })
...
function() {
    ...
    a = (new Date).getTime(), this.Stripe.isDoubleLoaded || (this.Stripe.ajaxJSONP = function(c) {
        ...
        }, h = (c.headers || {})["Accept-Language"], j = (c.headers || {})["Stripe-Account"], c.data || (c.data = {}), c.data.callback = f, c.method && (c.data._method = c.method), h && (c.data._accept_language = h), j && (c.data._stripe_account = j), i.src = c.url + "?" + Stripe.utils.serialize(c.data), g = document.getElementsByTagName("head")[0], g.appendChild(i), c.timeout > 0 && (e = setTimeout(function() {
